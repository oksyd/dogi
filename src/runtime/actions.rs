...
mod tests {
    use super::*;
    use crate::domain::{RuntimeActionSource, RuntimeKey};
    ...
    fn executes_supported_actions_and_reports_status() {
        let actions = vec![
            ...
            ResolvedRuntimeAction {
                source: RuntimeActionSource::Button(crate::domain::Master3sButton::Middle),
    ...
    fn skips_noop_and_unsupported_without_touching_executor() {
        let actions = vec![
            ResolvedRuntimeAction {
                source: RuntimeActionSource::Button(crate::domain::Master3sButton::Back),
