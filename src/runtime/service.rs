...
const STATIC_DEBIAN_UNIT: &str = include_str!("../../packaging/linux/dogi-runtime.service");
const PORTABLE_UNIT_TEMPLATE: &str = include_str!("../../packaging/linux/dogi-runtime.service.in");
